import { Overlay, CdkOverlayOrigin, CdkConnectedOverlay, OverlayModule } from '@takkion/ng-cdk/overlay';
...
import { _countGroupLabelsBeforeOption, _getOptionScrollPosition, _ErrorStateTracker, MAT_OPTION_PARENT_COMPONENT, MatOption, MAT_OPTGROUP, MatOptionModule, MatCommonModule } from '@takkion/ng-material/core';
export { MatOptgroup, MatOption } from '@takkion/ng-material/core';
...
export { MatError, MatFormField, MatHint, MatLabel, MatPrefix, MatSuffix } from '@takkion/ng-material/form-field';
...
import { removeAriaReferencedId, addAriaReferencedId, ActiveDescendantKeyManager } from '@takkion/ng-cdk/a11y';
