 ...
 * can be no dependency on `@takkion/ng-material` in the `package.json` file, and we need
...
function default_1(options) {
    return (host, context) => {
        ...
        const materialVersionRange = (0, package_config_1.getPackageVersionFromPackageJson)(host, '@takkion/ng-material');
        const angularDependencyVersion = ngCoreVersionTag || `^17.0.0 || ^18.0.0`;
        // The CLI inserts `@takkion/ng-material` into the `package.json` before this schematic runs.
        ...
        if (materialVersionRange === null) {
            (0, package_config_1.addPackageToPackageJson)(host, '@takkion/ng-material', fallbackMaterialVersionRange);
        }
