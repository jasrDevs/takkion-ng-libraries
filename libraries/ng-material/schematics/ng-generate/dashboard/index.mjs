...
function addNavModulesToModule(options) {
    return async (host) => {
        ...
        if (!isStandalone) {
            ...
            (0, schematics_2.addModuleImportToModule)(host, modulePath, 'MatGridListModule', '@takkion/ng-material/grid-list');
            (0, schematics_2.addModuleImportToModule)(host, modulePath, 'MatCardModule', '@takkion/ng-material/card');
            (0, schematics_2.addModuleImportToModule)(host, modulePath, 'MatMenuModule', '@takkion/ng-material/menu');
