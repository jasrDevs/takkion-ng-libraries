...
function addTableModulesToModule(options) {
    return async (host) => {
        ...
        if (!isStandalone) {
            ...
            (0, schematics_2.addModuleImportToModule)(host, modulePath, 'MatTableModule', '@takkion/ng-material/table');
            (0, schematics_2.addModuleImportToModule)(host, modulePath, 'MatPaginatorModule', '@takkion/ng-material/paginator');
            (0, schematics_2.addModuleImportToModule)(host, modulePath, 'MatSortModule', '@takkion/ng-material/sort');
        }
    };
}
