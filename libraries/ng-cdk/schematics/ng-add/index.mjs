...
function default_1() {
    return (host, context) => {
        // The CLI inserts `@takkion/ng-cdk` into the `package.json` before this schematic runs. This
        ...
        if ((0, package_config_1.getPackageVersionFromPackageJson)(host, '@takkion/ng-cdk') === null) {
            ...
            (0, package_config_1.addPackageToPackageJson)(host, '@takkion/ng-cdk', `~17.3.1`);
