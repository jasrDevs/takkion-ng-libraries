import { coerceNumberProperty, coerceElement } from '@takkion/ng-cdk/coercion';
...
import { getRtlScrollAxisType, RtlScrollAxisType, supportsScrollBehavior, Platform } from '@takkion/ng-cdk/platform';
